        ...
        class MockURLProtocol: URLProtocol {
            ...
            override class func canonicalRequest(for request: URLRequest) -> URLRequest {
                ...
                case "/v3/oauth/login":
                    ...
                    let redirectUri = String(requestBody[requestBody.index(requestBody.startIndex, offsetBy: range.location)...requestBody.index(requestBody.startIndex, offsetBy: range.location + range.length - 1)]).removingPercentEncoding!
            ...
            override func startLoading() {
                ...
                case "/v3/oauth/auth":
                    ...
                    let range = textCheckingResult.range(at: 1)
                    let redirectUri = String(requestUrlQuery[requestUrlQuery.index(requestUrlQuery.startIndex, offsetBy: range.location)...requestUrlQuery.index(requestUrlQuery.startIndex, offsetBy: range.location + range.length - 1)]).removingPercentEncoding!
